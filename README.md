...
Polynomial contrasts (K=4,6,8) benefit from GPU at N≥500k. Bounded contrasts (ltanh, lexp) achieve 40–48x speedup across all sizes due to O(N²) pairwise computation. Full benchmark table: [KORR/icalcc](https://github.com/Kleinverse/research/tree/main/icalcc).
